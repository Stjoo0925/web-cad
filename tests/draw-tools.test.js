...
test("line-tool.js 파일이 존재해야 함", async () => {
  const filePath = path.resolve(__dirname, "../packages/sdk-react/src/tools/line-tool.js");
...
test("polyline-tool.js 파일이 존재해야 함", async () => {
  const filePath = path.resolve(__dirname, "../packages/sdk-react/src/tools/polyline-tool.js");
  const exists = await fs.access(filePath).then(() => true).catch(() => false);
...
test("완료 이벤트/콜백이 있어야 함", async () => {
  const linePath = path.resolve(__dirname, "../packages/sdk-react/src/tools/line-tool.js");
  const polyPath = path.resolve(__dirname, "../packages/sdk-react/src/tools/polyline-tool.js");
